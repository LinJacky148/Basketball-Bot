...
def GetPlayer(name):
    url = 'https://china.nba.cn/stats2/player/stats.json?ds=profile&locale=zh_TW&playerCode={}'.format(name)
    ...
    PlayerDetail['body']['contents'].append(Seperater)
    PlayerDetail['footer']['contents'][0]['action']['uri'] = 'https://china.nba.cn/players/#!/{}'.format(name)
