...
if __name__ == "__main__":    
    ...
    #    
    data_feature = convert_data_to_feature(tokenizer,'nba.txt')
    ...
    train_dataloader = DataLoader(train_dataset,batch_size=1,shuffle=True) #16 GPU記憶體占比提高約800MB True
    test_dataloader = DataLoader(test_dataset,batch_size=1,shuffle=True) #16 GPU#16   True
