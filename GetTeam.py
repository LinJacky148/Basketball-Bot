...
def GetTeam():
    url = 'https://china.nba.cn/stats2/league/conferenceteamlist.json?locale=zh_TW'
        ...
        for Team in Teams:
            if(Team['profile']['division'] not in res[Group_Name]):
                res[Group_Name][Team['profile']['division']] = [{
                    ...
                    "logo" : 'https://res.nba.cn/media/img/teams/logos/{}_logo.png'.format(Team['profile']['abbr'].strip()),
